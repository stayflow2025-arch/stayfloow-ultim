...
Dans la console Firebase (Hosting ou App Hosting), supprimez tout domaine "Inactif" qui pointe vers `.pages.dev`. Recréez le domaine en choisissant "Héberger" (pas rediriger).
...
| **CNAME** | `_acme-challenge_4frcmtvf5fdmdejs` | `11ddb6dc-532b-4399-817d-4b0afb87c47b.18.authorize.certificatemanager.goog.` | Certificat SSL SSL |

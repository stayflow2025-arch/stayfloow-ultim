...
const translations: Record<string, Record<Locale, string>> = {
    ...
    "phone_whatsapp": { fr: "Numéro de téléphone (WhatsApp)", en: "Phone Number (WhatsApp)", ar: "رقم الهاتف (واتساب)", es: "Número de teléfono (WhatsApp)" },
    ...
    "ai_improve_btn": { fr: "Améliorer avec l'IA", en: "Improve with AI", ar: "تحسين باستخدام الذكاء الاصطناcii", es: "Mejorar con IA" },
